{
  ...
  map v58 v59 = case v59 of {
      Nil -> Nil;
      Cons v322 v323 ->
        Cons (v58 v322) (map v58 v323)
      };
  
  concatMap v62 v63 = case v63 of
      {
      Nil -> Nil;
      Cons v324 v325 ->
        append (v62 v324) (concatMap v62 v325)
      };
  ...
  foldr v70 v71 v72 = case v72 of
      {
      Nil -> v71;
      Cons v328 v329 ->
        v70 v328 (foldr v70 v71 v329)
      };
  ...
  sorted v106
    = foldr (ordins v106) Nil;
  
  ordins v107 v108 v109 = case
      v109 of {
      Nil -> Cons v108 Nil;
      Cons v346 v347 -> case
          (v107 v108 v346) of {
          ...
          False ->
            Cons v346 (ordins v107 v108 v347)
          }
      };
  ...
  hinsert^^0 v1 v2 = (-) v1 v2;
  
  hash v182 v183 = case v183 of {
      K v395 v396 v397 v398 ->
        (+) v398 (hash^^0 (assoc v396 v182) (assoc v397 v182))
      };
  ...
  emitHashFun v189 = case v189 of
      ...
      Cons v402 v403 -> case v402 of {
          Pair v404 v405 ->
            (+) (emitHashFun^^0 v404 v405) (emitHashFun v403)
          }
      };
  
  emitHashFun^^0 v1 v2 = (+) v1 v2
}
