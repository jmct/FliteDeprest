{
  ...
  elemAt v77 v78 = case v77 of {
      Cons v504 v505 -> case
          ((==) v78 0) of {
          True -> v504;
          False -> elemAt v505 ((-) v78 1)
          }
      };
  
  map v81 v82 = case v82 of {
      Nil -> Nil;
      Cons v506 v507 ->
        Cons (v81 v506) (map v81 v507)
      };
  
  concatMap v85 v86 = case v86 of
      {
      Nil -> Nil;
      Cons v508 v509 ->
        append (v85 v508) (concatMap v85 v509)
      };
  
  any v89 v90 = case v90 of {
      Nil -> False;
      Cons v510 v511 ->
        dis (v89 v510) (any v89 v511)
      };
  
  foldr v93 v94 v95 = case v95 of
      {
      Nil -> v94;
      Cons v512 v513 ->
        v93 v512 (foldr v93 v94 v513)
      };
  ...
  concatMap2 v182 v183 = case v183
    of {
      Empty -> Nil;
      Map v561 v562 v563 ->
        append (v182 v561 v562) (concatMap2 v182 v563)
      };
  ...
  pawnmoves v231 v232 v233 = case
      ...
      Pair v592 v593 -> let {
          ...
          v596 = Pair v592 ((+) (pawnmoves^^0 v593 v594) v594)
          } in (append (case
  ...
  any2 v249 v250 = case v250 of {
      Empty -> False;
      Map v599 v600 v601 ->
        dis (v249 v599 v600) (any2 v249 v601)
      };
    ...
    = case v259 of {
      Pair v602 v603 -> case
          ...
          Pair v604 v605 -> case v258 of {
              ...
              Bishop ->
                dis (con ((==) (kingInCheckFrom^^0 v602 v603) (kingInCheckFrom^^1 v604 v605)) (emptyAtAll v257 (diagPath minus ((-) v604 v605) v602 v604))) (con ((==) (kingInCheckFrom^^2 v602 v603) (kingInCheckFrom^^3 v604 v605)) (emptyAtAll v257 (diagPath plus ((+) v604 v605) v602 v604)));
              Knight ->
  ...
  kingInCheckFrom^^0 v1 v2
    = (-) v1 v2;
  
  kingInCheckFrom^^1 v1 v2
    = (-) v1 v2;
  
  kingInCheckFrom^^2 v1 v2
    = (+) v1 v2;
  
  kingInCheckFrom^^3 v1 v2
    = (+) v1 v2;
  ...
  filePath v263 v264 v265 v266
    = case v266 of {
      Pair v606 v607 ->
        con ((==) v606 v263) (con ((<=) (filePath^^0 (min v264 v265) 1) v607) ((<=) v607 (filePath^^1 (max v264 v265) 1)))
      };
  
  filePath^^0 v1 v2 = (+) v1 v2;
  
  filePath^^1 v1 v2 = (-) v1 v2;
  
  rankPath v269 v270 v271 v272
    = case v272 of {
      Pair v608 v609 ->
        con ((==) v609 v269) (con ((<=) (rankPath^^0 (min v270 v271) 1) v608) ((<=) v608 (rankPath^^1 (max v270 v271) 1)))
      };
  
  rankPath^^0 v1 v2 = (+) v1 v2;
  
  rankPath^^1 v1 v2 = (-) v1 v2;
  
  diagPath v275 v276 v277 v278 v279
    = case v279 of {
      Pair v610 v611 ->
        con ((==) (v275 v610 v611) v276) (con ((<=) (diagPath^^0 (min v277 v278) 1) v610) ((<=) v610 (diagPath^^1 (max v277 v278) 1)))
      };
  
  diagPath^^0 v1 v2 = (+) v1 v2;
  
  diagPath^^1 v1 v2 = (-) v1 v2;
  
  solve v282 v283 v284
    = showResult (solution v282 v283 ((-) (solve^^0 v284 v284) 1));
