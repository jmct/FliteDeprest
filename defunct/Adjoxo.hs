{
  ...
  gridFull v50 v51
    = (==) ((+) (length v50) (length v51)) 9;
  
  foldr1^bestOf v26 = case v26 of
      {
      Cons v93 v94 -> case v94 of {
          Nil -> v93;
          Cons v95 v96 ->
            bestOf v93 (foldr1^bestOf (Cons v95 v96))
          }
      };
  
  map^moveval v54 v55 v11 = case
      v11 of {
      Nil -> Nil;
      Cons v89 v90 ->
        Cons (moveval v54 v55 v89) (map^moveval v54 v55 v90)
      };
